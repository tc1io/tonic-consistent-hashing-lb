...
//     Ok(())
// }
//--------------------------------------Greeter client - Example end-----------------------------//


//---------------------------------------Delay service - Example start---------------------------------//
...
impl Service<&'static str> for DelayService {
    ...
    fn call(&mut self, request: &'static str) -> Self::Future {
        ...
        //let conn = tonic::transport::Endpoint::new("http://0.0.0.0:8087")?.connect().await?;
        let fut = async move{
